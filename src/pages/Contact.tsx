  ...
  return (
    <section id="contact" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-5 gap-6 items-stretch fade-in-up">
          
          {/* Left Side */}
          <div className="lg:col-span-3 bg-white rounded-[2rem] shadow-lg border border-gray-100 p-8 md:p-12 transition-all duration-300 hover:shadow-xl relative overflow-hidden group">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            {/* Location Card */}
            <div className="bg-white rounded-[2rem] shadow-lg border border-gray-100 p-8 flex-1 flex flex-col justify-center items-center text-center transition-all duration-300 hover:shadow-xl relative overflow-hidden group">
            ...
            {/* Social Media Card */}
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-[2rem] shadow-lg p-8 text-center flex flex-col justify-center items-center">
